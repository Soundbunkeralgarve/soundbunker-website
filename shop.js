...
let basket = [], quote = null, revision = 0, busy = false, next = 0, selectedCategory = 'all', selectedCollection = 'all', adultConfirmed = false, catalogEpoch = 0;
...
document.getElementById('age-confirm').onclick=()=>{adultConfirmed=true;catalogEpoch++;document.getElementById('age-gate').close();next=0;selectCollection('crude-city');renderBasket();loadProducts();};
...
function addCouplesCombo(){
 ...
 const image=el('img');image.src='/assets/shop/mockups/crude-city-couples.webp';image.alt='Man wearing Horny Bastard and woman wearing Horny Bitch in the Crude City two-shirt combo';image.width=900;image.height=600;image.loading='lazy';image.className='campaign-image';
