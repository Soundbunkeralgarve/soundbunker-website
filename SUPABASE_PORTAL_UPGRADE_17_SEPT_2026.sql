...
-- SoundBunker Social member profiles, presence and live chat.
...
create policy "Members upload own social avatar" on storage.objects for insert to authenticated
...
create policy "Members update own social avatar" on storage.objects for update to authenticated
...
create policy "Public social avatars" on storage.objects for select to public
